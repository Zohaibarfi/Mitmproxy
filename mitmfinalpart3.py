...
with open("/Users/macos/zohaib/Proxy flow.txt", "r") as f1:
    with open("/Users/macos/zohaib/List3.txt", "w") as f3:
        for line in f1:
            f3.write(line)
                ...
                if ip_match:
                    ...
                    if reason_match:
                        ...
                        if (domain, ip) not in failure_entries:
                            ...
                            with open("/Users/macos/zohaib/List3.txt", "a") as list3_file:
                                list3_file.write(f"Domain: {domain}, IP: {ip}, Status: failure, Reason: {reason}\n")
            ...
            if domain_match:
                ...
                if ip_match:
                    ...
                    if (domain, ip) not in success_entries and (domain, ip) not in failure_entries:
                        with open("/Users/macos/zohaib/List3.txt", "a") as list3_file:
                            list3_file.write(f"Domain: {domain}, IP: {ip}, Status: success, Reason: unknown\n")
