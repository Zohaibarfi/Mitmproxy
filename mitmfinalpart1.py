                ...
                if ip_match:
                    ...
                    if reason_match:
                        ...
                        if (domain, ip) not in failure_entries:
                            ...
                            with open("/Users/macos/zohaib/List1.txt", "a") as list1_file:
                                list1_file.write(f"Domain: {domain}, IP: {ip}, Status: failure, Reason: {reason}\n")
            ...
            if domain_match:
                ...
                if ip_match:
                    ...
                    if (domain, ip) not in success_entries and (domain, ip) not in failure_entries:
                        with open("/Users/macos/zohaib/List1.txt", "a") as list1_file:
                            list1_file.write(f"Domain: {domain}, IP: {ip}, Status: success, Reason: unknown\n")
